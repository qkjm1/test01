...
//        //호출 키워드/ 호출 될 값
//        //시각적으로 편해짐, 관리가 용의해짐
//        age.put("철수나이", 20); // array의 add 와 같음
//        age.put("영희나이", 20);
//        age.put("영수나이", 20);
//
//        System.out.println(age.get("철수나이"));
//        System.out.println(age.get("영희나이"));
//        System.out.println(age.get("영수나이"));         // 값은 get으로 호출
//
//
//
//        /// sacaner 이용
//
//        // next는 공백 이후를 저장하지 않음
//        // sc가 실행되었을 때 끝나지않도록 하는 방법 예외처리와 반복문을 이용하는방법잉 있음
...
//            try {
//                a= sc.nextInt();
//                sc.nextLine();// 입력된 공간을 다시 비움>> 최초의 입력이 a라는 변수(프로세스)에 흔적으로 계속 남기때문
//                // nextLine이 없으면 잘못 입력된 값이 흔적으로 남아 무한루프에 빠짐
//                // 문자 또는 엔터를 치기 전까지의 문장 전체를 입력받음
//                break;
